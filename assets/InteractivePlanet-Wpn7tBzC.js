import{r as o,j as t}from"./index-B7ShmS4y.js";const u=()=>{const s=o.useRef(null);return o.useEffect(()=>{const r=s.current;if(!r)return;const a=document.createElement("style");a.textContent=`
      @keyframes sparkle {
        0% { 
          opacity: 1; 
          transform: scale(1); 

const FloatingOrbs = () => {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-[-30]">
      ...
      <div className="absolute w-28 h-28 rounded-full bg-gradient-to-r from-pink-400/5 to-transparent animate-float-orb top-1/6 right-1/3 delay-1000" />
      <div className="absolute w-32 h-32 rounded-full bg-gradient-to-r from-green-400/5 to-transparent animate-float-orb bottom-1/4 right-1/6 delay-2000" />
    </div>
  );
};
